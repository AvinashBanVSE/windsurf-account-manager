  ...
  >
      ...
      <div class="settings-section">
        ...
        <div class="setting-item">
          <div class="setting-info">
            ...
            <span class="setting-desc">Enable Vibe and Replace for advanced code editing</span>
          </div>
        ...
        <div class="setting-item">
          <div class="setting-info">
            ...
            <span class="setting-desc">Install Windsurf in team GitHub organization for PR review</span>
          </div>
      ...
      <div class="settings-section">
        ...
        <div class="setting-item">
          <div class="setting-info">
            ...
            <span class="setting-desc">Manage and verify team domain names</span>
          </div>
        ...
        <div class="setting-item">
          <div class="setting-info">
            ...
            <span class="setting-desc">Set up Azure, Google, Okta or custom SAML SSO</span>
          </div>
          <el-button size="small" disabled>Configure</el-button>
        </div>
        ...
        <div class="setting-item">
          <div class="setting-info">
            ...
            <span class="setting-desc">Manage list of roles users can have</span>
          </div>
          <el-button size="small" disabled>Configure</el-button>
        </div>
        ...
        <div class="setting-item">
          <div class="setting-info">
            ...
            <span class="setting-desc">Individual-level usage analytics</span>
          </div>
        ...
        <div class="setting-item">
          <div class="setting-info">
            ...
            <span class="setting-desc">When enabled, Windsurf will block writing attributed code</span>
          </div>
    ...
    >
      <div class="models-config" v-loading="loadingModels">
        <p class="models-desc">Configure models to use in Windsurf, multiple models can be selected per category</p>
    ...
    >
      <div class="mcp-add-dialog">
        ...
        <div class="mcp-help-text">
          Need help? View <el-link type="primary" href="https://docs.windsurf.com/mcp" target="_blank">documentation</el-link> for configuration details
        </div>
...
async function loadSettings() {
  ...
  try {
    ...
    if (result.success && result.data) {
      ...
      // Helper function: get field value (supports int_X and X formats)
      ...
      // Allow fields (allow_xxx): if exists and is 1, then true
      ...
      // Disable fields (disable_xxx): if is 1, function is disabled, UI shows off
      // If field doesn't exist, function is enabled
  ...
  try {
    ...
    if (modelConfigResult.success && modelConfigResult.data) {
      ...
      if (Array.isArray(field1)) {
        ...
        // Check if there's a nested repeated field
      ...
      if (Array.isArray(modelConfigs)) {
        modelConfigs.forEach((config: any, idx: number) => {
          ...
          // multiplier field (field 3): multiplier, no field means free model
      ...
      // Available models = all models, selected models = disabled=false models
...
// multiplier field (field 3): multiplier, no field means free model
    ...
    // Get current team's model config
    ...
    if (controlsResult.success && controlsResult.data) {
      ...
      // Parse team_id, may contain protobuf prefix needing cleanup
      ...
      // Only override if API returns selected models, otherwise keep default from Recommended list
...
function saveCodemapsConfig() {
  // Codemaps settings will be saved together with main save
